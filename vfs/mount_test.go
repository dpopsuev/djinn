...
func TestMountTable_MountAndTranslate(t *testing.T) {
	...
	err := mt.Mount("/workspace/djinn", "/home/user/Workspace/djinn", false, scope.ScopeSystem)
	if err != nil {
...
func TestMountTable_MountConflict(t *testing.T) {
	...
	err = mt.Mount("/workspace/djinn", "/other/path", false, scope.ScopeSystem)
...
func TestMountTable_LongestPrefixMatch(t *testing.T) {
	...
	if err := mt.Mount("/workspace", "/mnt/workspace", true, scope.ScopeGlobal); err != nil {
		t.Fatal(err)
	}
	if err := mt.Mount("/workspace/djinn", "/home/user/Workspace/djinn", false, scope.ScopeSystem); err != nil {
		t.Fatal(err)
	}
...
func TestMountTable_List(t *testing.T) {
	...
	mt.Mount("/workspace/misbah", "/home/user/misbah", false, scope.ScopeSystem)   //nolint:errcheck // test setup, error not relevant
	mt.Mount("/workspace/djinn", "/home/user/djinn", false, scope.ScopeSystem)     //nolint:errcheck // test setup, error not relevant
	mt.Mount("/workspace/scribe", "/home/user/scribe", true, scope.ScopeEcosystem) //nolint:errcheck // test setup, error not relevant
	...
	if list[2].ScopeType != scope.ScopeEcosystem {
...
func TestMountTable_NilLogger(t *testing.T) {
	...
	if err := mt.Mount("/a", "/b", false, scope.ScopeSystem); err != nil {
		t.Fatal(err)
	}
}
