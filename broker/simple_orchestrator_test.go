...
func TestSimpleOrchestrator_FourStageHappyPath(t *testing.T) {
	...
	plan := WorkPlan{
		ID: "test-1",
		Stages: []Stage{
			{Name: "analyze", Scope: workspace.TierScope{Level: workspace.Eco}, Prompt: "analyze"},
			{Name: "code", Scope: workspace.TierScope{Level: workspace.Com}, Prompt: "code"},
			{Name: "test", Scope: workspace.TierScope{Level: workspace.Mod}, Prompt: "test"},
			{Name: "review", Scope: workspace.TierScope{Level: workspace.Sys}, Prompt: "review"},
		},
	}
...
func TestSimpleOrchestrator_GateFailure(t *testing.T) {
	...
	plan := WorkPlan{
		ID: "test-fail",
		Stages: []Stage{
			{Name: "code", Scope: workspace.TierScope{Level: workspace.Mod}, Prompt: "code"},
		},
	}
...
func TestSimpleOrchestrator_Cancel(t *testing.T) {
	...
	plan := WorkPlan{
		ID:     "cancel-test",
		Stages: []Stage{{Name: "long", Scope: workspace.TierScope{Level: workspace.Mod}, Prompt: "wait"}},
	}
...
func TestSimpleOrchestrator_TimeBudget(t *testing.T) {
	...
	plan := WorkPlan{
		...
		Stages: []Stage{{
			Name:       "slow",
			Scope:      workspace.TierScope{Level: workspace.Mod},
			Prompt:     "work",
...
func TestSimpleOrchestrator_Submit(t *testing.T) {
	...
	plan := WorkPlan{
		ID:     "submit-test",
		Stages: []Stage{{Name: "code", Scope: workspace.TierScope{Level: workspace.Mod}, Prompt: "code"}},
	}
