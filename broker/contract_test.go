...
type OrchestratorFactory func(
	createSandbox func(ctx context.Context, scope workspace.TierScope) (string, error),
...
func contractHappyPath(t *testing.T, factory OrchestratorFactory) { //nolint:thelper // contract test, not helper
	...
	plan := WorkPlan{
		ID: "contract-happy",
		Stages: []Stage{
			{Name: "s1", Scope: workspace.TierScope{Level: workspace.Mod}, Prompt: "p1"},
			{Name: "s2", Scope: workspace.TierScope{Level: workspace.Com}, Prompt: "p2"},
		},
	}
...
func contractCancelTerminates(t *testing.T, factory OrchestratorFactory) { //nolint:thelper // contract test
	...
	plan := WorkPlan{
		ID:     "contract-cancel",
		Stages: []Stage{{Name: "block", Scope: workspace.TierScope{Level: workspace.Mod}, Prompt: "wait"}},
	}
...
func contractEventsInOrder(t *testing.T, factory OrchestratorFactory) { //nolint:thelper // contract test
	...
	plan := WorkPlan{
		ID:     "contract-order",
		Stages: []Stage{{Name: "s1", Scope: workspace.TierScope{Level: workspace.Mod}, Prompt: "p1"}},
	}
