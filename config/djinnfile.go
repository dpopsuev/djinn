// djinnfile.go — parses Djinnfile configuration into WorkPlans.
...
type Djinnfile struct {
	...
	Driver  DjinnfileDriverConfig `json:"driver"`
}
...
// DjinnfileDriverConfig holds LLM driver configuration for Djinnfile stages.
type DjinnfileDriverConfig struct {
...
// ParseDjinnfile reads a Djinnfile from a reader and validates it.
func ParseDjinnfile(r io.Reader) (*Djinnfile, error) {
	var df Djinnfile
...
// ParseDjinnfileBytes parses a Djinnfile from a byte slice.
func ParseDjinnfileBytes(data []byte) (*Djinnfile, error) {
	var df Djinnfile
