...
func TestHub_E2E_ShellHotSwap(t *testing.T) {
	...
	defer backend.Close()
	backend.SendToShell(clutch.BackendMsg{Type: clutch.BackendReady, Model: "test"}) //nolint:errcheck
	...
	shell1.SendToBackend(clutch.ShellMsg{Type: clutch.ShellPrompt, Text: "hello"}) //nolint:errcheck
	...
	// Backend responds.
	backend.SendToShell(clutch.BackendMsg{Type: clutch.BackendText, Text: "world"}) //nolint:errcheck
	...
	backend.SendToShell(clutch.BackendMsg{Type: clutch.BackendText, Text: "queued-after-crash"}) //nolint:errcheck
	time.Sleep(100 * time.Millisecond)
	...
	shell2.SendToBackend(clutch.ShellMsg{Type: clutch.ShellPrompt, Text: "from-rebuilt-shell"}) //nolint:errcheck
...
func TestHub_E2E_BackendHotSwap(t *testing.T) {
	...
	be1.SendToShell(clutch.BackendMsg{Type: clutch.BackendReady, Model: "v1"}) //nolint:errcheck
	...
	// Exchange messages.
	shell.SendToBackend(clutch.ShellMsg{Type: clutch.ShellPrompt, Text: "p1"}) //nolint:errcheck
	m1, _ := be1.RecvFromShell()
	if m1.Text != "p1" {
		t.Fatalf("be1 got %q", m1.Text)
	}
	be1.SendToShell(clutch.BackendMsg{Type: clutch.BackendText, Text: "r1"}) //nolint:errcheck
	...
	shell.SendToBackend(clutch.ShellMsg{Type: clutch.ShellPrompt, Text: "queued-prompt"}) //nolint:errcheck
	time.Sleep(100 * time.Millisecond)
	...
	be2.SendToShell(clutch.BackendMsg{Type: clutch.BackendReady, Model: "v2"}) //nolint:errcheck
...
func TestHub_E2E_FullRebuild(t *testing.T) {
	...
	be1.SendToShell(clutch.BackendMsg{Type: clutch.BackendReady, HistoryLen: 10}) //nolint:errcheck
	...
	be2.SendToShell(clutch.BackendMsg{Type: clutch.BackendReady, HistoryLen: 15}) //nolint:errcheck
	...
	shell2.SendToBackend(clutch.ShellMsg{Type: clutch.ShellPrompt, Text: "alive"}) //nolint:errcheck
