...
func executeWorkspaceSwitch(cmd Command, sess *contextmgr.Session) CommandResult {
	if len(cmd.Args) < 1 {
...
func executeWorkspaceAdd(cmd Command, sess *contextmgr.Session) CommandResult {
	if len(cmd.Args) < 1 {
...
func executeWorkspaceRepos(sess *contextmgr.Session) CommandResult {
...
func executeWorkspaceSave(sess *contextmgr.Session) CommandResult {
	if sess.Workspace == "" {
...
func executeWorkspace(cmd Command, sess *contextmgr.Session) CommandResult {
	if len(cmd.Args) == 0 {
