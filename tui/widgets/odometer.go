...
var _ core.Panel = (*OdometerLine)(nil)

// NewOdometerLine creates an odometer with zeroed counters.
func NewOdometerLine() *OdometerLine {
	return &OdometerLine{
		BasePanel: core.NewBasePanel(panelIDOdometer, 1),
	}
}

// Update handles OdometerUpdateMsg.
func (o *OdometerLine) Update(msg tea.Msg) (core.Panel, tea.Cmd) {
	if m, ok := msg.(tui.OdometerUpdateMsg); ok {
