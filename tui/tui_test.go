...
func TestRenderHealth_AllGreen(t *testing.T) {
	reports := []tui.HealthReport{
		{Component: "a", Status: tui.StatusGreen},
		{Component: "b", Status: tui.StatusGreen},
	}
	result := tui.RenderHealth(reports)
...
func TestRenderStatusLine_Structure(t *testing.T) {
	result := tui.RenderStatusLine("aeon", "claude", "opus", "agent", 100, 50, 3, nil)
	if result == "" {
...
func TestOutputPanel_ViewNeverDimmed(t *testing.T) {
	...
	dimmed := tui.RenderWithDepth(view, 1, 80)
...
func TestGlamourInsideBorder_TrueColor_NoVisibleANSI(t *testing.T) {
	...
	tui.InitRenderer(80)
	rendered := tui.RenderMarkdown("Hello **world**, how are you? This is a longer sentence to trigger glamour padding.")
	if rendered == "" {
		t.Fatal("glamour should produce output")
	}

	bordered := tui.RenderWithDepth(rendered, 0, 80)
...
func TestGlamourInsideBorder_NoVisibleANSI(t *testing.T) {
	...
	rendered := tui.RenderMarkdown("Hello **world**, how are you?")
	if rendered == "" {
		t.Fatal("glamour should produce output")
	}
