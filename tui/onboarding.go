...
func (m OnboardingModel) View() string {
	...
	b.WriteString(logo.Render(DjinnLogo))
	b.WriteString("\n\n")
...
func (m OnboardingModel) renderDriverList() string {
	...
	for i, d := range m.drivers {
		...
		if d.Version != "" {
			...
			version = DimStyle.Render("  " + v)
		}
		if d.Source == "api-key" {
			path = DimStyle.Render("(API key set)")
		}
	...
	b.WriteString("\n")
	b.WriteString(DimStyle.Render("  j/k navigate · enter select · q quit"))
	b.WriteString("\n")
