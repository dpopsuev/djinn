...
func TestToolHub_Execute_Mediation(t *testing.T) {
	...
	executor := &hubStubExecutor{result: "ok"}
...
type hubStubExecutor struct {
	result string
	tools  []builtin.Tool
	names  []string
}

func (e *hubStubExecutor) Execute(_ context.Context, _ string, _ json.RawMessage) (string, error) {
	return e.result, nil
}

func (e *hubStubExecutor) All() []builtin.Tool { return e.tools }
func (e *hubStubExecutor) Names() []string     { return e.names }
