// adapter.go — MisbahSandbox implements sandbox.Sandbox using the Misbah substrate.
...
// MisbahSandbox implements sandbox.Sandbox backed by a Misbah substrate.
type MisbahSandbox struct {
	port *SandboxPort
}

// NewMisbahSandbox creates a sandbox backed by the Misbah substrate.
